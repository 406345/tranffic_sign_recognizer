...
//            return false;
        ...
        try {
            ...
            frameGrabber = new FFmpegFrameGrabber( frameSocket.getInputStream(),5);
            frameGrabber.setFrameRate(this.getCodecInfo().frmRate);
            frameGrabber.setFormat("h264");
            frameGrabber.setPixelFormat(AV_PIX_FMT_RGBA);
            frameGrabber.setVideoBitrate(this.getCodecInfo().bitRate);
            frameGrabber.setVideoOption("preset", "ultrafast");
            frameGrabber.setNumBuffers(1024*1024*100);
